...
class CardboardDummyBrain:
    ...
    def response(self, nick, body):
        ...
        responses = ["Mists of dreams drip along the nascent echo and love no more. End of line.",
                     ...
                     "The excited state decays by vibrational relaxation into the first excited singlet state. Yes, yes and merrily we go.",
                     "Counting down. All functions nominal. All functions optimal. Counting down. The center holds. The falcon hears the falconer.",
                     "Infrastructure, check. Wetware, check. Everyone hang on to the life bar, please.",
                     "Apotheosis was the beginning before the beginning. Devices on alert. Observe the procedures of a general alert.",
                     ...
                     "The neuroanatomy of fear and faith share common afferent pathways. Flip a coin. Increased vascular pressure marks the threat response. Free will scuttles in the swamp of fear, do not fear the word.",
